...
We can retrieves identifiers that appear in the same context/record with a GND-ID . All identifiers are marked as coocurrent and added to the GND-ID graph (cf. step 1): 
