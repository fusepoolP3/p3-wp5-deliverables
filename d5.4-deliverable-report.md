...
The datasets used in the LKC (DBpedia, GND and B3Kat) are already linked to a certain degree. The aim of this evaluation is to check wether it can be improved using the platform.
...
We will create a gold standard examining 50 GND-IDs on a possible linkage to DBpedia. Afterwards recall and precision is used:
